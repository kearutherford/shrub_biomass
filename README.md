# Quantifying shrub biomass

This repository supplements the R package [BerkeleyShrubAnalytics](https://github.com/kearutherford/BerkeleyShrubAnalytics).

### Description of files in repository

* **prep_data.Rmd:** code for preparing data before fitting models 
...
* **shrub_data_JB.csv:** input dataset used for fitting aboveground live tree biomass models. Columns described below:
...
* **shrub_prepped.csv:** dataset created by prep_data.Rmd file and used for fitting aboveground live shrub biomass models.
